    ...
    <div className="">
      ...
      <div className="min-w-full">
        <div className={` w-[100%] flex`}>
          ...
          <div className="w-full pt-[10vh] lg:p-6 min-h-[98vh] font-sans justify-center items-center p-3">
            <div className="lg:w-full p-2 pt-16 bg-white shadow-lg shadow-gray-400 rounded-xl h-full">
